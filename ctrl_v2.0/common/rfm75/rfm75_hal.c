...
void rfm75_hal_hw_init_1(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0; // A0 - IRQ
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
	GPIO_Init(GPIOA, &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2; // A2 - CE
	...
	SPI_InitStructure.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_4; // 8 - 5MHz, 4 - 2.5MHz
	...
	TIM_TimeBaseStructure.TIM_Period = RFM75_CFG_DELAY_US; // us
	TIM_TimeBaseStructure.TIM_ClockDivision = 0;
	TIM_TimeBaseStructure.TIM_RepetitionCounter = 0;
	TIM_TimeBaseInit(TIM14, &TIM_TimeBaseStructure); // 42 MHz clocking
